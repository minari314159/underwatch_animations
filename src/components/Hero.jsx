...
const Hero = () => {
	...
	const nextVdRef = useRef(null); //use to target a specific dom element
	...
	return (
		<section className="relative h-dvh w-screen overflow-x-hidden">
			...
			<div
				...
				<div>
					<div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-full">
						<div
					...
					<video
						...
						muted
						id="next-video"
						className="absolute-center invisible abslute z-20 size-64 object-cover object-center"
						onLoadedData={handleVideoLoad}
					/>
					<video
						src={getVideoSrc(
					...
					<div className="absolute left-0 top-0 z-40 size-full ">
						<div className="mt-24 px-5 sm:px-10">
							...
							<Button
								...
								containerClass="!bg-neon flex-center gap-1"
								url="FqnKB22pOC0"
							/>
						</div>
					</div>
